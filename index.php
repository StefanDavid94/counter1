...
<header><div id="popUp">
  ...
  <div id="new"><span>Don</span></div>
  <p>Ce site a été créé bénévolement afin de soutenir moralement tous les parents qui en ont besoin. Si vous aimez le contenu qui a été créé et que vous le trouvez utile, vous pouvez symboliquement soutenir le créateur en lui offrant un café</p>

  <a href="https://www.buymeacoffee.com/" target="_blank" class="button btn btn-success">Soutenir</a>
</div>
<div id="plus"><span>Café<br>&nbsp;<i class="fa fa-coffee"></i></span></div>
</header>
    ...
    <!-- <div id="rc_logo">
      ...
      <nav class="nav" id="navbar">
        ...
        <ul class="nav-list" id="menu">
            <li><a href="#home" class="nav-item">Accueil</a></li>
            <!-- <li><a href="#about" class="nav-item">Pourquoi</a></li> -->
            <li><a href="#comments" class="nav-item">Temoignages</a></li>
            <!-- <li><a href="#sondage" class="nav-item">Liens utiles</a></li> -->
            <li><a href="#download-section" class="nav-item">Ressources</a></li>
            ...
            <!-- <li><a href="https://www.buymeacoffee.com/" target="_blank" class="nav-item">Faire un don</a></li> -->
    ...
    <div class="hero" id="home">
      <div class="counterDiv">
        <h1 class="main-title animation">Parents en colère</h1>
 <p class="hero-paragraph center">Compteur de parents privés de ses enfants </p>
        <!-- <p class="hero-paragraph">
          Aujourd'hui beaucoup de parents en France sont privés de ses enfants ou ils les voient très peu.
          Ici nous voudrons quelle est la chiffre exacte de parents qui ne peuvent pas exercer son role
        </p> -->


        <span id="countSpan" class="countRes">Chargement...</span>
        <br />

        <button id="incBtn" type="submit" onclick="hello(this)" class="vote-btn">Moi aussi</button>
<!-- 
        <button id="removeStorage">Effacer le localStorage</button> -->
<!-- 
        <div class="message">
          <div class="success" id="success">Merci pour votre contribution !</div>
        </div> -->
        ...
        <section id="about" class="about-section">
          ...
          <div class="container">
            <h2 class="h2 left">A propos de ce site </h2>


            <p class="paragraph left"> Ce site a été créé pour soutenir tous ces parents qui ne peuvent pas voir et élever leurs enfants pour des raisons totalement injustifiées. </p>

            <p class="paragraph left"> Aujourd'hui, nous constatons que de plus en plus de parents, principalement des pères, sont totalement exclus de la vie de leurs enfants pour des raisons souvent injustifiées.  Ils sont aussi très souvent victimes de manipulations et d'aliénation parentale. 
              Ce site a été créé pour soutenir tous les parents qui ne peuvent exercer leur droit fondamental d'élever leurs enfants.</p>
  ...
  <div class="t-bq-wrapper t-bq-wrapper-boxed">
      <div class="t-bq-quote t-bq-quote-mike">
          ...
          <div class="t-bq-quote-mike-base">
              <blockquote class="t-bq-quote-mike-text" cite="LOI n° 2002-305 du 4 mars 2002">
    ...
    <div class="container">
      <form method="POST" id="comment_form">
       ...
       <div class="form-group">
        <textarea style="resize: none;" name="comment_content" id="comment_content" class="form-control" placeholder="Redigez votre commentaire" maxlength="1000" rows="12"></textarea>
       </div>
       <div class="form-group">
...
<!-- <h2 class="h2 center">Documentation utile</h2> -->
<!-- <p class="paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente laboriosam ratione laudantium impedit. Rem laboriosam, vero dolorum dignissimos laudantium ipsa.</p> -->


<div class="download-container">
  <h3 class="h3">Ressources juridiques</h3>
  <a class="btn btn-primary" target="_blank" href="joomdev.com" download>
<i class="fa-solid fa-file-pdf"></i> Télécharger</a>
</div>
</section>
...
<section class="contact-section" id="contact">
  ...
  <script src="https://cdn02.jotfor.ms/static/prototype.forms.js?3.3.35690" type="text/javascript"></script>
  <script src="https://cdn03.jotfor.ms/static/jotform.forms.js?3.3.35690" type="text/javascript"></script>
  ...
  if (window.JotForm && JotForm.accessible) $('input_4').setAttribute('tabindex',0);
        JotForm.setCustomHint( 'input_4', 'Bonjour...' );
    /*INIT-END*/
    });
  
     JotForm.prepareCalculationsOnTheFly([null,null,{"name":"envoyer","qid":"2","text":"Envoyer","type":"control_button"},null,{"name":"message4","qid":"4","subLabel":"","text":"Message","type":"control_textarea"},null,null,{"name":"mail","qid":"7","subLabel":"exemple@exemple.com","text":"Mail","type":"control_email"},{"name":"nomEt","qid":"8","text":"Nom et Prenom ","type":"control_textbox"},{"name":"clickTo","qid":"9","text":"Contact ","type":"control_head"}]);
     setTimeout(function() {
  JotForm.paymentExtrasOnTheFly([null,null,{"name":"envoyer","qid":"2","text":"Envoyer","type":"control_button"},null,{"name":"message4","qid":"4","subLabel":"","text":"Message","type":"control_textarea"},null,null,{"name":"mail","qid":"7","subLabel":"exemple@exemple.com","text":"Mail","type":"control_email"},{"name":"nomEt","qid":"8","text":"Nom et Prenom ","type":"control_textbox"},{"name":"clickTo","qid":"9","text":"Contact ","type":"control_head"}]);}, 20); 
  </script>
  <link href="https://cdn01.jotfor.ms/static/formCss.css?3.3.35690" rel="stylesheet" type="text/css" />
  <link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/css/styles/nova.css?3.3.35690" />
  <style type="text/css">@media print{.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}</style>
  <link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.35690" />
  <style type="text/css">
      .form-label-left{
          width:150px;
      }
  ...
  */
  ...
  <link type="text/css" rel="stylesheet" href="https://cdn01.jotfor.ms/css/styles/buttons/form-submit-button-simple_green_apple.css?3.3.35690"/>
  <form class="jotform-form" action="https://submit.jotformeu.com/submit/222486519232457/" method="post" name="form_222486519232457" id="222486519232457" accept-charset="utf-8" autocomplete="on">
    <input type="hidden" name="formID" value="222486519232457" />
    <input type="hidden" id="JWTContainer" value="" />
    <input type="hidden" id="cardinalOrderNumber" value="" />
    <div style="margin: 0 auto; width: 700px; max-width: 100%;" role="main" class="form-all">
      <ul class="form-section page-section">
        <li id="cid_9" class="form-input-wide" data-type="control_head">
          <div class="form-header-group  header-large">
            <div class="header-text httal htvam">
              <h2 class="h2 center" class="form-header" data-component="header">
                Contact
              </h2>
              <!-- <div id="subHeader_9" class="form-subHeader">
                Pour toutes vos suggestions et questions
              </div> -->
              <p id="subHeader_9" class="paragraph center">
                Pour toutes vos suggestions et questions
              </p>
            </div>
          </div>
        ...
        <li class="form-line jf-required" data-type="control_textbox" id="id_8">
          ...
          <div id="cid_8" class="form-input-wide jf-required">
            <input type="text" id="input_8" name="q8_nomEt" data-type="input-textbox" class="form-textbox validate[required]" data-defaultvalue="" size="25" value="" placeholder=" " data-component="textbox" aria-labelledby="label_8" required="" />
          </div>
        </li>
        <li class="form-line jf-required" data-type="control_email" id="id_7">
          ...
          <div id="cid_7" class="form-input-wide jf-required">
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="email" id="input_7" name="q7_mail" class="form-textbox validate[required, Email]" data-defaultvalue="" size="25" value="" placeholder=" " data-component="email" aria-labelledby="label_7 sublabel_input_7" required="" />
        ...
        <li class="form-line jf-required" data-type="control_textarea" id="id_4">
          ...
          <div id="cid_4" class="form-input-wide jf-required">
            <div class="form-textarea-limit">
              <span>
                <textarea style="resize: none;" id="input_4" class="form-textarea validate[required]" name="q4_message4" cols="25" rows="6" data-component="textarea" required=""></textarea>
                <div class="form-textarea-limit-indicator">
                  <span data-limit="1000" type="Letters" data-minimum="-1" data-typeminimum="Letters" id="input_4-limit">
                    0/1000
                  </span>
                </div>
              </span>
        ...
        <li class="form-line" data-type="control_button" id="id_2">
          <div id="cid_2" class="form-input-wide">
            <div style="text-align:center" data-align="center" class="form-buttons-wrapper form-buttons-center   jsTest-button-wrapperField">
              <button style="width: 100%;" id="input_2" type="submit" class="btn btn-success" data-component="button" data-content="">
                Envoyer
              </button>
            </div>
          </div>
    ...
    <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="222486519232457" />
    <script type="text/javascript">
    var all_spc = document.querySelectorAll("form[id='222486519232457'] .si" + "mple" + "_spc");
  for (var i = 0; i < all_spc.length; i++)
  {
    all_spc[i].value = "222486519232457-222486519232457";
  }
    </script>
...
<!-- footer -->
<footer>
  <p>&copy; Tous droits réservés 2022</p>
</footer>
    <script type="module">
      // Import the functions you need from the SDKs you need
      import { initializeApp } from "https://www.gstatic.com/firebasejs/9.8.4/firebase-app.js";
      // import { getDatabase, ref, child, get, update } from "https://www.gstatic.com/firebasejs/9.8.4/firebase-database.js";
      ...
      const firebaseConfig = {
        apiKey: "AIzaSyCkKIEhywEOaoFcDCDbwSAFXzfLpCqyZB0",
        authDomain: "papaencollere.firebaseapp.com",
        databaseURL:
          "https://papaencollere-default-rtdb.europe-west1.firebasedatabase.app",
        projectId: "papaencollere",
        storageBucket: "papaencollere.appspot.com",
        messagingSenderId: "653282798499",
        appId: "1:653282798499:web:8db2d409611a57118a0816",
        measurementId: "G-TMZF3HBS86"
      };
...
//     location.href = "../papacounter/registration/register.php";

// }


// localstorage hide button

function showHide() {
	if(localStorage.getItem('cacher')) {
		document.querySelector("#incBtn").style.setProperty('display', 'none', '');
	} else {
		document.querySelector("#incBtn").style.removeProperty('display');
	}
}
showHide();

document.querySelector("#incBtn").addEventListener('click', function(e) {
	localStorage.setItem('cacher', true);
	showHide();
})


document.querySelector("#removeStorage").addEventListener('click', function() {
	//pour effacer un item spécific du localStorage :
	localStorage.removeItem('cacher');
	showHide();
})


// end of localstorage hide button
